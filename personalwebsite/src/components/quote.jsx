...
export const Quote2 = () => {
    ...
    return (
        ...
        <div className="h-screen flex flex-col justify-center items-center">
            ...
            <button className="w-40 bg-black hover:bg-white hover:text-black text-white font-normal py-2 px-4 rounded mt-4 border-2 border-black" onMouseEnter={() => setText("Connect with me")} onMouseLeave={() => setText("Ready?")}>
                {text}
            </button>
        </div>
